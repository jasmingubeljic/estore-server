...
const validateCreateProduct = [
  ...
  body("categoryId").trim().notEmpty().withMessage("Plese choose category to which this product belongs"),
];
...
router.post("/product", isAuth, validateCreateProduct, adminController.createProduct);
router.put("/product/:id", isAuth, adminController.updateProduct);
router.delete("/product/:id", isAuth, adminController.deleteProduct);
router.post("/category", isAuth, validateCreateCategory, adminController.createCategory);
